package com.bykov.jobilee.security.jwt;
 ...
 *
 * <p>Метод generateAccessToken принимает объект User и создает новый токен доступа,
 * устанавливая его срок
...
public class JwtCore {
    ...
    public String generateAccessToken(User employee){
    ...
    public String generateRefreshToken(User employee){
        LocalDateTime now = LocalDateTime.now();
